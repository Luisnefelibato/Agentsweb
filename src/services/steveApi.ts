...
export const sendMessage = async (message: string, userName: string = API_CONFIG.userName) => {
  try {
    return await retryRequest(async () => {
      console.log('Enviando mensaje a Steve API:', { message, user_name: userName });
      ...
      console.log('Respuesta recibida de Steve API:', response.data);
    ...
    console.error('Error enviando mensaje a Steve API:', error);
    throw error;
  }
};
